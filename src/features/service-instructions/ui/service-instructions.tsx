    ...
    <div className="mx-auto w-full max-w-6xl py-4">
      ...
      <article className="mt-8 space-y-4" id="orders">
        ...
        <Step number={2} title="Список и статусы заказов">
          <p>В карточке видны номер и источник заказа, способ получения («Самовывоз» или «Доставка»), статус, количество позиций, сумма, срок сборки и комментарий. Действия доступны сразу на мини-карточке; нажмите саму карточку, чтобы открыть её полную версию, или номер заказа, чтобы посмотреть состав.</p>
        ...
        <Step number={3} title="Кнопки заказа">
          <ul className="space-y-3">
            ...
            <li><strong>Открыть заказ»</strong> — открывает форму проверки состава. В ней можно отменить отдельные строки, после чего подтвердить заказ.</li>
